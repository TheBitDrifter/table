...
type config struct {
	AutoComponentRegistrationTableCreation          bool
	AutoComponentRegistrationLockedAccessorCreation bool
	buildTags                                       []buildTag
}

var Config config = config{
	AutoComponentRegistrationTableCreation: true,
}
